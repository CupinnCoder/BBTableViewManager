...
{
    self[@"__NSCFConstantString"] = @"BBTableViewCell";
    self[@"__NSCFString"] = @"BBTableViewCell";
    self[@"NSString"] = @"BBTableViewCell";
    self[@"BBTableViewItem"] = @"BBTableViewCell";
}
...
- (Class)classForCellAtIndexPath:(NSIndexPath *)indexPath {
    BBTableViewSection *section = [self.mutableSections objectAtIndex:indexPath.section];
...
- (NSInteger)tableView:(UITableView *)tableView numberOfRowsInSection:(NSInteger)section {
    ...
    return ((BBTableViewSection *)[self.mutableSections objectAtIndex:section]).items.count;
}

- (ASCellNode *)tableView:(ASTableView *)tableView nodeForRowAtIndexPath:(NSIndexPath *)indexPath
{
    BBTableViewSection *section = [self.mutableSections objectAtIndex:indexPath.section];
    BBTableViewItem *item = [section.items objectAtIndex:indexPath.row];
    
    Class cellClass = [self classForCellAtIndexPath:indexPath];
    BBTableViewCell *cell = [[cellClass alloc] initWithTableViewItem:item];
...
- (NSString *)tableView:(UITableView *)tableView titleForHeaderInSection:(NSInteger)section {
    ...
    BBTableViewSection *tableViewSection = [self.mutableSections objectAtIndex:section];
...
{
    BBTableViewSection *sourceSection = [self.mutableSections objectAtIndex:sourceIndexPath.section];
    BBTableViewItem *item = [sourceSection.items objectAtIndex:sourceIndexPath.row];
    [sourceSection removeItemAtIndex:sourceIndexPath.row];
    
    BBTableViewSection *destinationSection = [self.mutableSections objectAtIndex:destinationIndexPath.section];
        ...
        if (item.deletionHandlerWithCompletion) {
            item.deletionHandlerWithCompletion(item, ^{
                ...
                for (NSInteger i = indexPath.row; i < section.items.count; i++) {
                    ...
                    BBTableViewCell *cell = (BBTableViewCell *)[tableView cellForRowAtIndexPath:afterItem.indexPath];
                    cell.rowIndex--;
                }
            });
        } else {
...
- (void)tableView:(ASTableView *)tableView willDisplayNodeForRowAtIndexPath:(NSIndexPath *)indexPath {
    if ([self.delegate respondsToSelector:@selector(BB_tableView:willLoadCell:forRowAtIndexPath:)]) {
        BBTableViewCell *cell = (BBTableViewCell *)[tableView nodeForRowAtIndexPath:indexPath];
        [self.delegate BB_tableView:tableView willLoadCell:cell forRowAtIndexPath:indexPath];
    }
...
- (CGFloat)tableView:(UITableView *)tableView heightForHeaderInSection:(NSInteger)sectionIndex
{
    ...
    BBTableViewSection *section = [self.mutableSections objectAtIndex:sectionIndex];
